//+------------------------------------------------------------------+
//|                                             SuhabFiboTrader.mq5 |
//|                        Исправленная версия prompt22_stub_only   |
//+------------------------------------------------------------------+
...
//--- отключены, пока не нужна торговая логика
// #include <OrderInfo.mqh>
// #include <HistoryOrderInfo.mqh>
// #include <PositionInfo.mqh>
// #include <DealInfo.mqh>

// --- Заглушки для торговли (временно)
class COrderInfo { };
...
//    Вернуть их, когда понадобится торговая логика.
//+------------------------------------------------------------------+
