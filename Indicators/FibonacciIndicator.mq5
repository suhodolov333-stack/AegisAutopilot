...
input double   FibLevels[6] = {0, 0.236, 0.382, 0.5, 0.618, 1}; // Fibonacci levels
input color    LevelColor = clrBlue;     // Color of levels
input int      LevelWidth = 2;           // Line thickness
input ENUM_TIMEFRAMES Timeframe = PERIOD_D1; // Reference timeframe

//--- Internal variables
datetime startBarTime, endBarTime;
...
int OnCalculate(const int rates_total,
                ...
                const int &spread[])
  {
   ...
   int endBar = WindowBarsPerChart() + startBar - 1;
